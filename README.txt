A small, clean PyTorch implementation of a simple neural network (MLP) trained on the MNIST handwritten digit dataset.
...
- Achieves ~93% accuracy on the MNIST test set
